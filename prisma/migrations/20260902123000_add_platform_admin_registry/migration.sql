...
-- CreateIndex
CREATE UNIQUE INDEX "PlatformAdmin_provider_providerSubject_key" ON "public"."PlatformAdmin"("provider", "providerSubject");

-- CreateIndex
CREATE INDEX "PlatformAdmin_active_role_idx" ON "public"."PlatformAdmin"("active", "role");
