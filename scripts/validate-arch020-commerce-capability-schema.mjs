...
for(const f of ['arch020_current_snapshot','arch020_object','arch020_string','arch020_strings','arch020_bindings','arch020_grant_tools','arch020_definition','arch020_immutable','arch020_identity','arch020_revision','arch020_member','arch020_pointer','arch020_audit','arch020_grant','arch020_parent_owner']) assert.ok(sql.includes(`CREATE FUNCTION commerce.${f}(`),f);
